...
static const struct _dictionary_line dictionary[] = {
  ...
  {"bgp_blackhole_msglog_file", cfg_key_bgp_blackhole_msglog_file},
  {"bgp_blackhole_msglog_amqp_routing_key", cfg_key_bgp_blackhole_msglog_amqp_routing_key},
  {"bgp_blackhole_msglog_kafka_topic", cfg_key_bgp_blackhole_msglog_kafka_topic},
  {"bgp_blackhole_dump_file", cfg_key_bgp_blackhole_dump_file},
  {"bgp_blackhole_dump_latest_file", cfg_key_bgp_blackhole_dump_latest_file},
  {"bgp_blackhole_dump_amqp_routing_key", cfg_key_bgp_blackhole_dump_amqp_routing_key},
  {"bgp_blackhole_dump_kafka_topic", cfg_key_bgp_blackhole_dump_kafka_topic},
  ...
  {"custom_packet_parsing_lib", cfg_custom_packet_parsing_lib},
  {"", NULL}
};
